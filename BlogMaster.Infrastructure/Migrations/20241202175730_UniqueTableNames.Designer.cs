...
namespace BlogMaster.Infrastructure.Migrations
{
    ...
    [Migration("20241202175730_UniqueTableNames")]
    partial class UniqueTableNames
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlogMaster.Core.Models.Category", b =>
                {
                    ...
                    b.HasIndex("CatergoryNameEn")
                        .IsUnique()
                        .HasFilter("[CatergoryNameEn] IS NOT NULL");
            ...
            modelBuilder.Entity("BlogMaster.Core.Models.Identity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "236ed1f4-e838-4e22-a979-9422d7f525d5",
                            Email = "example@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "EXAMPLE@EXAMPLE.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEG384XIuPaTziLMQ8tQWoBhDr/htPLw/4Nli8q3WhwLoPSg2By1tSpmBViuQaae3mQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "0e7ef2be-91f8-4b27-9caf-9c1bdc47e831",
            ...
            modelBuilder.Entity("BlogMaster.Core.Models.Keyword", b =>
                {
                    ...
                    b.HasIndex("KeywordNameEn")
                        .IsUnique()
                        .HasFilter("[KeywordNameEn] IS NOT NULL");
            ...
            modelBuilder.Entity("BlogMaster.Core.Models.Tag", b =>
                {
                    ...
                    b.HasIndex("TagNameEn")
                        .IsUnique()
                        .HasFilter("[TagNameEn] IS NOT NULL");
